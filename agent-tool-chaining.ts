...
const agent = createAgent({
  ...
  systemPrompt: `You are an intelligent agent that can use tools to answer user queries. Use only information from provided context. Answer shortly and factually. Answer only what is asked.`, // Make sure to always use both tools when necessary to provide accurate answers. Use events tool only with valid location from addressBook tool.
});
